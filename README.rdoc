...
Returns:
  ...
  job_list: list of all the jobs
    ...
    session_list: list of all sessions associated to job. Could be only one
      ...
      state:
        type: int
        name: string ('committed', 'open', 'completed', 'active', 'pending')
...
Returns:
  success: boolean
  provider_list: list of all the providers to display
    user_id: int
    name: string
    staff: boolean
    session_list: list of all sessions provider assigned to
      ...
      state:
        type: int
        name: string ('committed', 'open', 'completed', 'active', 'pending')
    jobs_list: list of all the jobs provider assigned to
      job_id: int
      name: string
      attrib_list: list of job attributes used to filter view by
        language
